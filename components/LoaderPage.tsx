...
export const Loader: React.FC = () => {
    ...
    return (
        <div className={`fixed top-0 bottom-0 left-0 right-0 bg-black-default ${isShowed ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"} flex justify-center items-center z-30 transition-opacity duration-500`}>
